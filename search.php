...
<?php if (have_posts()) : ?>
    ...
    <header class="header">
        <h1 class="container px-2.5 entry-title text-2xl  text-gray-800 " itemprop="name">
            <?php printf(esc_html__('Товары по запросу: %s', 'blankslate'), get_search_query()); ?>
        </h1>
    </header>
...
<?php
get_template_part('module/widgetes/order-form', null, array());
get_template_part('module/mobileMenu', null, array());
get_footer();
?>